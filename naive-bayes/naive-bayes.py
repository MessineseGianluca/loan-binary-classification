...
predictions = nb_model.predict(test_samples)
...
probs = nb_model.predict_proba(test_samples)[:, 1]
...
cv_nb_model = GaussianNB()

# collecting cross validation scores
cv_scores = cross_val_score(cv_nb_model, samples, labels, cv=10)
